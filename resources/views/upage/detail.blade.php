              ...
              <div class="row ">
                <div class="col-lg-5">
                  <div class="product-slick ">
                    <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/001.jpg" alt="" class="img-fluid  image_zoom_cls-0"></div>
                    <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/002.jpg" alt="" class="img-fluid  image_zoom_cls-1"></div>
                    <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/003.jpg" alt="" class="img-fluid  image_zoom_cls-2"></div>
                    <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/004.jpg" alt="" class="img-fluid  image_zoom_cls-3"></div>
                  </div>
                  <div class="row">
                    <div class="col-12 p-0">
                      <div class="slider-nav">
                        <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/001.jpg" alt="" class="img-fluid"></div>
                        <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/002.jpg" alt="" class="img-fluid"></div>
                        <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/003.jpg" alt="" class="img-fluid"></div>
                        <div><img src="{{ asset('vendor/themes') }}/images/product-sidebar/004.jpg" alt="" class="img-fluid"></div>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="modal-bg addtocart">
                                  ...
                                  <div class="media">
                                      <a href="javascript:void(0)">
                                          <img src="{{ asset('vendor/themes') }}/images/layout-4/product/3.jpg" alt="cart-image" class="img-fluids">
                                      </a>
                                      <div class="media-body align-self-center text-center">
                                          ...
                                          <div class="upsell_payment">
                                              <img src="{{ asset('vendor/themes') }}/images/paymat.png" class="img-fluid " alt="cart-modal-popup">
                                          </div>
                                      </div>
                                  </div>
                                      ...
                                      <div class="row" id="upsell_product">
                                          <div class="product-box col-sm-3 col-6">
                                              <div class="img-wrapper">
                                                  <div class="front">
                                                      <a href="product-page(left-sidebar).html">
                                                          <img src="{{ asset('vendor/themes') }}/images/layout-4/product/1.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                      </a>
                                                  </div>
                                                  <div class="product-detail">
                                                    <a href="product-page(left-sidebar).html">
                                          ...
                                          <div class="product-box col-sm-3 col-6">
                                              <div class="img-wrapper">
                                                  <div class="front">
                                                      <a href="product-page(left-sidebar).html">
                                                          <img src="{{ asset('vendor/themes') }}/images/layout-4/product/2.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                      </a>
                                                  </div>
                                                  <div class="product-detail">
                                          ...
                                          <div class="product-box col-sm-3 col-6">
                                              <div class="img-wrapper">
                                                  <div class="front">
                                                      <a href="product-page(left-sidebar).html">
                                                          <img src="{{ asset('vendor/themes') }}/images/layout-4/product/a1.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                      </a>
                                                  </div>
                                                  <div class="product-detail">
                                          ...
                                          <div class="product-box col-sm-3 col-6">
                                              <div class="img-wrapper">
                                                  <div class="front">
                                                      <a href="product-page(left-sidebar).html">
                                                          <img src="{{ asset('vendor/themes') }}/images/layout-4/product/a2.jpg" class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                      </a>
                                                  </div>
                                                  <div class="product-detail">
